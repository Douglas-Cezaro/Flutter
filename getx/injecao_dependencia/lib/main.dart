...
void main() {
  // Injetando objeto na memoria
  // Get.put<UserController>(UserController()); //Instancia na hora
  Get.lazyPut<UserController>(() =>
      UserController()); //Instancia e é adicionado na memoria quando ele for usado
